...
# === CONFIG ===
base_dir = "/home/student/project/output/coco_data"
splits = [""] #["train", "val"]
json_dir = os.path.join("/home/student/project/output", "keypoints")
...
for split in splits:
    ...
    split_annot_dir = os.path.join(annotated_dir, split)
    os.makedirs(split_annot_dir, exist_ok=True)
    ...
    for filename in os.listdir(image_dir):
        ...
        out_path = os.path.join(split_annot_dir, f"annotated_{name}.png")
